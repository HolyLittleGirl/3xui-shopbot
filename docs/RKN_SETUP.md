...
**RKN Blocker** — модуль автоматической блокировки запрещённых в Российской Федерации ресурсов через iptables/ipset.
...
- ✅ **Автоматическая загрузка** списков с [antifilter.download](https://antifilter.download/)
- ✅ **Блокировка на уровне ядра** через iptables/ipset
- ✅ **Автообновление** каждые 30 минут
- ✅ **HTTP API** для интеграции с внешними системами
- ✅ **Консольное управление** через `rkn-block`
- ✅ **Telegram бот** и веб-панель для управления

### Источники блокировок

Используются списки с проекта antifilter.download:
- **allyouneed.lst** — комбинированный список (ipsum.lst + subnet.lst)
- ~14,000 подсетей/IP адресов
