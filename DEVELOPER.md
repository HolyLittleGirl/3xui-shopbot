...
- `true` — бот запускается автоматически (Режим автозапуска)
- `false` — бот запускается вручную через веб-панель (Development режим)

> Настройка в веб-панели (**Настройки → Настройка бота → Режим автозапуска**) имеет приоритет над переменной окружения.
...
- [ ] Включить **Режим автозапуска** в веб-панели
